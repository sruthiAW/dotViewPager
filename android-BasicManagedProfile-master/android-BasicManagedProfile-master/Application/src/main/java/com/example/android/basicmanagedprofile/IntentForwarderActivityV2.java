...
public class IntentForwarderActivityV2 extends Activity {
    public static String TAG = "IntentForwarderActivityV2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (className.equals(FORWARD_INTENT_TO_PARENT)) {
            ...
            Slog.wtf(TAG, IntentForwarderActivityV2.class.getName() + " cannot be called directly");
            userMessageId = -1;
